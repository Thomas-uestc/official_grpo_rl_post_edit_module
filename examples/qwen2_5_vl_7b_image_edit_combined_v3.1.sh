...
TRAIN_DATA_PATH=/path/to/your/training-dataset # replace with new training dataset downloaded from huggingface
...
python3 -m verl.trainer.main \
    ...
    data.parquet_pattern="json_qwen_edit_batch_*.parquet" \
    ...
    worker.reward.rule_re_edit_max_length_ideal=100 \
    worker.reward.rule_re_edit_max_length_acceptable=150 \
    worker.reward.rule_re_edit_max_length_tolerable=200 \
