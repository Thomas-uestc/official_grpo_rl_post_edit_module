...
class DataProto:
    ...
    For image editing tasks, the following fields are supported in non_tensor_batch:
    - original_images: List of original images (PIL Images or image paths)
    - preliminary_edited_images: List of preliminary edited images 
    - edit_instructions: List of edit instructions (strings)
    - expected_reasoning: List of expected reasoning clues (strings)
    - final_edited_images: List of final edited images (generated by edit model)
    - re_edit_instructions: List of re-edit instructions (generated by actor)
    """
