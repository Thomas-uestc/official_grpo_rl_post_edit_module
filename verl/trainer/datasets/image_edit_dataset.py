...
class ImageEditDataset(Dataset):
    ...
    def _create_prompt(self, edit_instruction: str, num_images: int = 2) -> str:
        ...
        # System prompt for CoT and re-edit instruction generation (XML tag format, unlimited)
        system_prompt = (
        ...
        "- The number of <CoT> tags is unlimited"
        "- The number of <Re_edit> tags is unlimited"
        "- No length restrictions on tag content "
        "- Use imperative voice in <Re_edit> tags "
